...
## Summary
- 1652 nodes · 2529 edges · 169 communities (137 shown, 32 thin omitted)
...
Cohesion: 0.10
Nodes (9): DeletePlaySessionAction, UpdatePlaySessionAction, DashboardController, PlaySessionController, PublicPlaySessionController, PushNotificationController, PlaySession, Illuminate\Support\Facades\Date (+1 more)
...
Cohesion: 0.14
Nodes (7): AttendanceSeeder, MembershipSeeder, MembershipTransactionSeeder, PlaySessionSeeder, ShuttlecockItemSeeder, StockMovementSeeder, Illuminate\Database\Seeder
...
Cohesion: 0.12
Nodes (8): CreateSessionRegistrationByAdminAction, DeleteSessionRegistrationAction, RecordSessionRegistrationPaymentAction, RegisterForPlaySessionAction, SendSessionRegistrationNotificationAction, SessionRegistrationController, CancelSessionRegistrationRequest, SessionRegistration
...
Cohesion: 0.15
Nodes (5): StoreMembershipRequest, StorePlaySessionRequest, StoreStockMovementRequest, UpdateMemberRequest, Illuminate\Foundation\Http\FormRequest
...
### Community 51 - "User"
Cohesion: 0.07
Nodes (10): AdjustMembershipCreditAction, DeleteMembershipAction, GrantMembershipAction, MembershipController, AdjustMembershipCreditRequest, Membership, User, Illuminate\Database\Eloquent\Relations\HasMany (+2 more)

### Community 52 - "Illuminate\Database\Eloquent\Factories\Factory"
Cohesion: 0.11
Nodes (10): AttendanceFactory, MembershipFactory, MembershipTransactionFactory, PlaySessionFactory, PushNotificationFactory, PushSubscriptionFactory, ShuttlecockItemFactory, StockMovementFactory (+2 more)
...
Cohesion: 0.22
Nodes (4): TopUpRequestController, StoreTopUpRequest, Illuminate\Support\Facades\Storage, Symfony\Component\HttpFoundation\StreamedResponse

### Community 59 - "PushSubscription"
Cohesion: 0.06
Nodes (29): PushNotificationSender, SendPushNotificationAction, send(), PushNotification, PushSubscription, AppServiceProvider, FirebaseCloudMessaging, PushNotificationManager (+21 more)
...
Cohesion: 0.09
Nodes (6): Attendance, ExpenseDetail, IncomeDetail, MembershipTransaction, StockMovement, Illuminate\Database\Eloquent\Relations\BelongsTo

### Community 71 - "TopUpSetting"
Cohesion: 0.20
Nodes (4): TopUpSetting, TopUpSettingFactory, TopUpSettingSeeder, self
...
### Community 78 - "Income"
Cohesion: 0.18
Nodes (3): Income, Illuminate\Database\Eloquent\Relations\HasOne, Illuminate\Foundation\Testing\RefreshDatabase

### Community 80 - "Illuminate\Http\RedirectResponse"
Cohesion: 0.11
Nodes (12): DeleteMemberAction, RecordStockMovementAction, AuthController, Controller, MemberController, NotificationSetupController, RegistrationController, StockMovementController (+4 more)

### Community 81 - "ResetLegacyPushSubscriptionsAction"
Cohesion: 0.27
Nodes (5): ResetLegacyPushSubscriptionsAction, RequireCurrentPushSetup, RequireMemberNotifications, Closure, Symfony\Component\HttpFoundation\Response
...
### Community 147 - "TopUpRequest"
Cohesion: 0.20
Nodes (3): ReviewTopUpRequestAction, TopUpRequest, TopUpRequestSeeder
...
## Knowledge Gaps
- **706 isolated node(s):** `composer install`, `Illuminate\\Foundation\\ComposerScripts::postAutoloadDump`, `Illuminate\\Foundation\\ComposerScripts::prePackageUninstall`, `@lint:check`, `npm install` (+701 more)
...
- **Why does `User` connect `User` to `PlaySession`, `Illuminate\Database\Eloquent\Model`, `SessionRegistrationFactory`, `TopUpRequest`, `CreateTopUpRequestAction.php`, `Illuminate\Support\Str`, `Illuminate\Database\Seeder`, `SessionRegistration`, `DatabaseSeeder.php`, `Illuminate\Validation\Rule`, `Illuminate\Foundation\Http\FormRequest`, `ShuttlecockItem`, `Illuminate\Database\Eloquent\Factories\Factory`, `Illuminate\Validation\ValidationException`, `PushSubscription`, `TopUpSetting`, `Income`, `Illuminate\Http\RedirectResponse`, `ResetLegacyPushSubscriptionsAction`, `UpdateSessionRegistrationRequest`, `UpdateSessionRegistrationAction`, `StoreSessionRegistrationByAdminRequest`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `PlaySession` connect `PlaySession` to `UpdateSessionRegistrationAction`, `UpdateSessionRegistrationPaymentRequest`, `SessionRegistration`, `Illuminate\Database\Eloquent\Model`, `Illuminate\Database\Eloquent\Relations\BelongsTo`, `FilterPlaySessionsRequest`, `UpdateSessionRegistrationRequest`, `Illuminate\Database\Seeder`, `Illuminate\Validation\Rule`, `SessionRegistrationFactory`, `ShuttlecockItem`, `User`, `Illuminate\Database\Eloquent\Factories\Factory`, `Illuminate\Validation\ValidationException`, `PushSubscription`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `PushSubscription` connect `PushSubscription` to `PlaySession`, `Illuminate\Database\Eloquent\Model`, `ResetLegacyPushSubscriptionsAction`, `Illuminate\Database\Eloquent\Factories\Factory`, `StorePushSubscriptionRequest`?**
