...
use App\Http\Controllers\MemberRotationController;
...
use App\Http\Middleware\RequireCompleteMemberProfile;
...
Route::middleware(['auth', RequireCurrentPushSetup::class, RequireMemberNotifications::class])->group(function () {
    ...
    Route::put('/profil/kata-sandi', [ProfileController::class, 'password'])->name('profile.password');
    Route::get('/profil/foto', [ProfileController::class, 'avatar'])->name('profile.avatar');
    Route::get('/pemain/{member}', [CommunityProfileController::class, 'show'])->name('community-profile.show');
    Route::get('/pemain/{member}/foto', [CommunityProfileController::class, 'avatar'])->name('community-profile.avatar');
    Route::get('/rotasi', [MemberRotationController::class, 'index'])->name('rotations.index');
    Route::get('/rotasi/{playSession}', [MemberRotationController::class, 'show'])->name('rotations.show');
    ...
    Route::middleware('can:admin')->withoutMiddleware(RequireMemberNotifications::class)->group(function () {
        ...
        Route::put('/play-sessions/{playSession}/registrations/{registration}/guest-attendance', [SessionRegistrationController::class, 'updateGuestAttendance'])->scopeBindings()->name('session-guests.attendance');
