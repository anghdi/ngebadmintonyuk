...
<div class="feed-studio-page" data-feed-editor
    ...
    <div class="page-heading flex flex-wrap items-end justify-between gap-4"><div><span class="eyebrow">GRID PREVIEW & EXPORT</span><h1>{{ $feedDesign->headline }}</h1><p>Periksa crop, sambungan, dan urutan upload.</p></div><a class="btn soft" href="{{ route('feed-studio.edit', $feedDesign) }}">Edit konten</a></div>
